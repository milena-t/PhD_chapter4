...
Trinity --seqType fq --max_memory 128G --genome_guided_bam /proj/naiss2024-6-73/Bianca/star/output_thirdAligned.out.sorted.bam \
...
--SS_lib_type FR \
--CPU 20 \
--output /crex/proj/snic2021-6-30/Bianca/trinity_with_ref

...
my_species <- c('busco', 'busco', 'busco', 'busco', 'busco', 'busco', 'busco', 'busco')
...
my_percentage <- c(28.1, 66.7, 2.4, 2.8, 25.9, 69.9, 1.6, 2.6)
my_values <- c(597, 1417, 50, 60, 550, 1484, 34, 56)

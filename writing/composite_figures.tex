...
\begin{figure}[H]
    ...
    \begin{center}
        \begin{subfigure}[t]{0.85\linewidth}
            \begin{picture}(0,0)
                \put(90,180){\textbf{A}} % adjust the x and y values here
            \end{picture}
    ...
    (\textbf{A}): UpSet plot showing the overlap of genes that are significantly day-biased in males or in females with each other and the genes that are significant 

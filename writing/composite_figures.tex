...
\begin{figure}[H]
    ...
    (\textbf{A}): UpSet plot showing the overlap of significantly sex-biased genes during different time points with each other and the genes that are significant in the day-by-sex interaction.
    Only intersections with at least 15 genes are shown.
    }\label{sex_split}

...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\linewidth}
	    ...
	    \begin{picture}(0,0)
   	  		\put(25,-10){\textbf{A}} % adjust the x and y values here
		\end{picture}
	    \begin{center}
    ...
    \begin{picture}(0,0)
   	  		\put(25,-10){\textbf{B}} % adjust the x and y values here
		\end{picture}
	    \begin{center}
    ...
    \begin{subfigure}[t]{0.32\linewidth}
        %\makebox[0pt][l]{\hspace{30pt}\textbf{D}}
        \begin{picture}(0,0)
                \put(25,-10){\textbf{C}} % adjust the x and y values here
            \end{picture}
            \begin{center}
    ...
    Genes significantly differentially expressed (red=FDR-p $<$ 0.05) in each developmental timepoint (301 genes in day 14, 281 genes in day 16, 14 genes in day 18). 
    Genes that are also line-biased in females are not shown. 
    }\label{day_split}
